...
let HP = Laptop(yearPurchased: 2020)

let Dell = Laptop(screenSize: 15, repairCount: 1, yearPurchased: 2021)
...
struct Height{
    ...
    init(heightInInches: Double = 65, heightInCentimeters: Double = 165.1 * 2.54) {
...
let someOnesHeight = Height(heightInInches: 65, heightInCentimeters: 165.1)

print("Height in inches is: \(someOnesHeight.heightInInches) and height in centmeters is: \(someOnesHeight.heightInCentimeters * 2.54)")
...
let myHeight = Height(heightInInches:68, heightInCentimeters: 68 * 2.54)
