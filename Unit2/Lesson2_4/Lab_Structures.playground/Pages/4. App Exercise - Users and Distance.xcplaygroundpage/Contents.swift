...
let ShirleyJo = User(name:"ShirleyJo Lee", age: 48, height: 68.0, weight: 255, activityLevel: 7)

print("User: \(ShirleyJo.name) Age: \(ShirleyJo.age) Height: \(ShirleyJo.height) Weight: \(ShirleyJo.weight) activityLevel: \(ShirleyJo.activityLevel)")
...
struct Distance {
    ...
    init(meters: Double = 1600, feet: Double = 5249.344) {
        self.meters = meters
        self.feet = feet
    }
}
...
let mile = Distance(meters: 1600, feet:5249.344)

print("Meters: \(mile.meters) and feet: \(mile.feet)")

//:  Now create another instance of `Distance` and give it some other distance. Ensure that both properties are set correctly.
let ScndMile = Distance(meters: 2500, feet: 8202.1)
    
print("Meters: \(ScndMile.meters) and Feet: \(ScndMile.feet)")
