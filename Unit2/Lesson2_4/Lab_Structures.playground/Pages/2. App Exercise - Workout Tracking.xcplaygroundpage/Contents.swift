...
print("Distance:\(RunningWorkout.distance), Time:\(RunningWorkout.time), elevation:\(RunningWorkout.elevation)")
...
var firstRun = RunningWorkout(distance: 2396.0, time:15.3, elevation: 94.0)
