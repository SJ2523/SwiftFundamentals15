 ...
 */
let ThsStrng: String = "Shirley-Jo"
 ...
 */
let favoriteQuote: String = "I have two favorite quotes, one of my favorite quotes is \"A smart man learns from his mistakes, but a wise man learns from the mistakes of others.\""
print(favoriteQuote)
