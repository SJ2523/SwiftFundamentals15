 ...
 */
let nameInCaps: String = "Shirley-Jo Lee"
let name: String = "shirley-jo lee"
...
if textToSearchThrough.contains("to be, or not to be") && textToSearchFor.contains("to be, or not to be"){
    print("I found it!")
}else{
    print("")
}
...
let MyName: String = "Shirley-Jo Lee"

print("My name contains \(MyName.count-1) characters.")
