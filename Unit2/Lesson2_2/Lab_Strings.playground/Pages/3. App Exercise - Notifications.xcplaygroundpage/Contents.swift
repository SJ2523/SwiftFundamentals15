 ...
 */
let firstName: String = "Narrow"
let lastName: String = "Road"
...
print("congratulations,\(fullName)! You beat your previous high score of \(previousBest) steps by walking \(newBest) steps yesterday!")
/*:
