...
if let januaryDays = daysInMonth ["January"] {
    ...
    print("January not found in the dictionary")
}

//:  Given the following arrays, create a new [String : [String]] dictionary. `shapesArray` should use the key "Shapes" and `colorsArray` should use the key "Colors." Print the resulting dictionary.
let shapesArray: [String] = ["Circle","Square","Triangle","Rectangle"]
let colorsArray: [String] = ["Red","Yellow","Blue","White","Green"]
...
if let colors = shapesAndColors["Colors"], let lastColor = colors.last {
    ...
    print("Could not retrieve the last color.")
}
